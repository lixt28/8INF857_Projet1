...
-- force le chemin des règles pour Snort 3
...
alert_json =
{
    file = true,  -- => écrit dans alert_json.txt sous -l
    fields = 'seconds msg rule action proto src_addr src_port dst_addr dst_port'
    -- limit = 1000000,      -- optionnel
    -- separator = ", "      -- optionnel
}
