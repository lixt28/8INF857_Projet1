...
2. **Sélectionne** :  
   ...
   - **Dashboards** : `Snort – Overview`  
   - **Visualizations** liées  
   - (Option) Saved searches si tu en as  
3. Coche **“Include related objects”**, puis **Export** → télécharge le fichier `kibana-saved-objects.ndjson`.
